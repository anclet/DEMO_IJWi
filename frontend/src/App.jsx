...
function App() {
  ...
  const handleStart = async () => {
    setLoading(true);
    const data = await startAssistant(firstName);
    setCallId(data.id);
  };
  ...
  return (
    <div className="app-container">
      {showForm && (
        <>
          <h1>🔒 Your privacy matters! Pick a nickname to start.</h1>
          <input
            type="text"
            placeholder="Enter a nickname you would like to be called"
            value={firstName}
...
//   const handleStart = async () => {
//     setLoading(true);
//     const data = await startAssistant(firstName, lastName);
//     setCallId(data.id);
//   };
